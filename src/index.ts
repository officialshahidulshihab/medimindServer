...
import healthProfileRoutes from './routes/health-profile.route';
import healthDocumentRoutes from './routes/health-documents.route';
import drugCheckRoutes from './routes/drug-checks.route';
import symptomSessionRoutes from './routes/symptom-sessions.route';
